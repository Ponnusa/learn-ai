...
export interface Translation {
  ...
  teacher: {
    ...
    dimDecisionMaking: string;
    dimJustification: string;
    dimConstraintAwareness: string;
    dimTransfer: string;
    dimAcademicUnderstanding: string;
    levelLimitedEvidence: string;
    ...
    supportIndependent: string;
    supportOccasional: string;
    supportHeavy: string;
    supportNotApplicable: string;
    reasonFocusQuiz: string;
    reasonFocusStudyset: string;
    reasonLowQuizScore: string;
    reasonNotEngagedVideo: string;
    reasonNotEngagedChat: string;
    statVisited: string;
    statAvgQuiz: string;
    statAvgQuizTooltip: string;
    statMastered: string;
    statMasteredTooltip: string;
    statGuided: string;
    statGuidedTooltip: string;
    statAvgSteps: string;
    statAvgStepsTooltip: string;
    statLastActive: string;
    thinkingRadarRollupLabel: string;
    focusRecommendationLabel: string;
    noSessionsResolvedYet: string;
    completeResultLabel: string;
    rollingUpProgress: string;
    couldNotLoadSummary: string;
    levelOverTimeLabel: string;
    trendOverallLabel: string;
    usuallySupportLabel: string;
    confidenceSuffixLabel: string;
    ladderSessionReportLabel: string;
    regenerateReportTooltip: string;
    regenerateSummaryTooltip: string;
    latestLabel: string;
    noSessionsForConcept: string;
    generatingReportLabel: string;
    generatingReportHint: string;
    reportGenerationFailed: string;
    resolvedInStepsLabel: string;
    thinkingRadarSectionLabel: string;
    confidenceLabel: string;
    supportLevelLabel: string;
    observableEvidenceLabel: string;
    nextGrowthStepPrefix: string;
    strengthsLabel: string;
    areasForGrowthLabel: string;
    nextStepsLabel: string;
    teacherInsightLabel: string;
    suggestedNextTopicLabel: string;
    optionalExtensionLabel: string;
    ...
    existingStudentsTab: string;
    newStudentsTab: string;
    searchStudentsPlaceholder: string;
    noExistingStudents: string;
    fromClassroomLabel: string;
    addSelected: string;
    addingStudents: string;
    studentNamesLabel: string;
    studentNamesPlaceholder: string;
    defaultPasswordLabel: string;
    provisionBtn: string;
    provisioningBtn: string;
    credentialsReady: string;
    loginEmailCol: string;
