...
export const en: Translation = {
  ...
  chat: {
    ...
    exploratoryExit: 'Exit',
    exploratoryResolved: "You've got it!",
    exploratoryBackToChat: 'Back to chat',
    exploratoryPlaceholder: 'Type your answer…',
    exploratorySummary: 'Explored together — resolved in {steps} step(s) ✅',
