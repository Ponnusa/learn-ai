...
export const updateLanguage = (userId: string, language: 'en' | 'fi' | 'sv' | 'es' | 'fr' | 'no', token?: string) =>
...
export interface ContentBlock {
  id:           string;
  type:         'text' | 'video' | 'audio' | 'embed_video' | 'embed_image' | 'embed_pdf' | 'pipeline_clip' | 'pipeline_image';
  position:     number;
  title:        string | null;
  body:         string | null;
